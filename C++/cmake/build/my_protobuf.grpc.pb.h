...
class transactionTest final {
 public:
  ...
  typedef WithAsyncMethod_IimageOimage<WithAsyncMethod_ItextOtext<WithAsyncMethod_IjsonOjson<Service > > > AsyncService;
  template <class BaseClass>
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_IimageOimage<ExperimentalWithCallbackMethod_ItextOtext<ExperimentalWithCallbackMethod_IjsonOjson<Service > > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_IimageOimage<ExperimentalWithCallbackMethod_ItextOtext<ExperimentalWithCallbackMethod_IjsonOjson<Service > > > ExperimentalCallbackService;
  template <class BaseClass>
   ...
   public:
    WithStreamedUnaryMethod_IimageOimage() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::my_protobuf::ImageType, ::my_protobuf::ImageType>(std::bind(&WithStreamedUnaryMethod_IimageOimage<BaseClass>::StreamedIimageOimage, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_ItextOtext() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::internal::StreamedUnaryHandler< ::my_protobuf::TextType, ::my_protobuf::TextType>(std::bind(&WithStreamedUnaryMethod_ItextOtext<BaseClass>::StreamedItextOtext, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_IjsonOjson() {
      ::grpc::Service::MarkMethodStreamed(2,
        new ::grpc::internal::StreamedUnaryHandler< ::my_protobuf::JSONType, ::my_protobuf::JSONType>(std::bind(&WithStreamedUnaryMethod_IjsonOjson<BaseClass>::StreamedIjsonOjson, this, std::placeholders::_1, std::placeholders::_2)));
    }
  ...
  typedef WithStreamedUnaryMethod_IimageOimage<WithStreamedUnaryMethod_ItextOtext<WithStreamedUnaryMethod_IjsonOjson<Service > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_IimageOimage<WithStreamedUnaryMethod_ItextOtext<WithStreamedUnaryMethod_IjsonOjson<Service > > > StreamedService;
};
